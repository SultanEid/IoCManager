...
public sealed class SubmitAdjudicationRequestValidator : AbstractValidator<SubmitAdjudicationRequestDto>
{
    ...
    public SubmitAdjudicationRequestValidator()
    {
    ...
    private static bool HasObservedAt(SubmitAdjudicationRequestDto request)
    {
    ...
    private static bool HasValidArtifactsBounds(SubmitAdjudicationRequestDto request)
    {
    ...
    private static bool HasRequiredPackageIds(SubmitAdjudicationRequestDto request)
    {
    ...
    private static bool HasValidEvidenceBounds(SubmitAdjudicationRequestDto request)
    {
    ...
    private static bool HasMatchingCaseAndDetectionIds(SubmitAdjudicationRequestDto request)
    {
