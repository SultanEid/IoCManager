...
export const STATUS_TONE_BY_KEY: Record<string, string> = {
  ...
  benign: "border-emerald-300/35 bg-emerald-400/12 text-emerald-200",
  likelybenign: "border-cyan-300/35 bg-cyan-400/10 text-cyan-100",
  suspicious: "border-amber-300/35 bg-amber-400/12 text-amber-200",
  likelymalicious: "border-orange-300/40 bg-orange-400/12 text-orange-100",
  malicious: "border-rose-300/40 bg-rose-400/12 text-rose-200",
