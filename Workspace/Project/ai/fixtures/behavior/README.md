...
- Current styles include CAPE, Cuckoo, and VirusTotal-like summary payloads.
- Detection fixtures may reference report IDs via `behavior_report_references.reports[]`.
