...
def adjudicate_sigma(
    *,
    ...
    return SigmaAdjudicationResult(
        verdict=verdict,
...
def _explanation_lines(
    *,
    ...
    lines = [
        (
            "SIGMA deterministic adjudication produced "
    ...
    if lexical_only_gate_triggered:
        lines.append("Lexical-only evidence was detected; adjudication abstained pending non-lexical corroboration.")
    else:
        lines.append(
