...
def test_snort_decision_is_deterministic_for_identical_input() -> None:
...
def test_snort_decision_extracts_interpretable_features_for_required_inputs() -> None:
...
def test_snort_decision_scores_evidence_buckets_independently() -> None:
    result = adjudicate_snort(detection_package=_malicious_package())
...
def test_snort_decision_hard_abstains_when_only_lexical_evidence_exists() -> None:
...
def test_snort_decision_history_signals_change_bucket_outputs() -> None:
...
def test_snort_decision_classifies_into_runtime_verdict_taxonomy(
    builder,
...
def test_snort_decision_distinguishes_policy_noise_from_threat_driven_detections() -> None:
...
def test_snort_decision_produces_explanation_and_suggested_checks() -> None:
    result = adjudicate_snort(detection_package=_insufficient_evidence_package())
    assert "SNORT deterministic decision produced verdict=" in result.explanation
