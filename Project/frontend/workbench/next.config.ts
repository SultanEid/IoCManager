...
const nextConfig: NextConfig = {
  async redirects() {
    return [
      ...
      { source: "/coverage", destination: "/reporting", permanent: false },
      { source: "/coverage/telemetry", destination: "/reporting", permanent: false },
      { source: "/coverage/sources", destination: "/reporting", permanent: false },
      { source: "/coverage/attack", destination: "/reporting", permanent: false },
      { source: "/coverage-pain-analysis", destination: "/reporting", permanent: false },
      { source: "/ioc-registry", destination: "/reporting", permanent: false },
      { source: "/ioc-registry/:path*", destination: "/reporting", permanent: false },
      { source: "/reports", destination: "/reporting", permanent: false },
